...
#else
#define AM335X_YT8521_EVM_PHY_ID	0x0000011a
#define AM335X_EVM_PHY_ID	0x4dd074
#endif

#define AM335X_YT8521_EVM_PHY_MASK		0x00000fff
#define YT8521_PHY_DEBUG_ADDR_REG	0x1e
#define YT8521_PHY_DEBUG_DATA_REG	0x1f
#define RGMII_Config1  0xA003
#define LED0_CFG       0xA00C
#define LED1_CFG       0xA00D
#define LED2_CFG       0xA00E
#define LED_BLINK_CFG  0xA00F
...
static int am33xx_evm_tx_clk_dly_phy_fixup_YT8521(struct phy_device *phydev)
{
	/*tx_delay 2ns*/
	phy_write(phydev, YT8521_PHY_DEBUG_ADDR_REG,RGMII_Config1);
        phy_write(phydev, YT8521_PHY_DEBUG_DATA_REG, 0x34ff);
        
	/*led blink_hz */
        phy_write(phydev, YT8521_PHY_DEBUG_ADDR_REG,LED_BLINK_CFG);
        phy_write(phydev, YT8521_PHY_DEBUG_DATA_REG,0x0048);
       
	/*led1 blink*/
        phy_write(phydev, YT8521_PHY_DEBUG_ADDR_REG,LED1_CFG);
        phy_write(phydev, YT8521_PHY_DEBUG_DATA_REG,0x2600);
       
	/*led2 light or dark*/
        phy_write(phydev, YT8521_PHY_DEBUG_ADDR_REG,LED2_CFG);
        phy_write(phydev, YT8521_PHY_DEBUG_DATA_REG,0x1870);
	return 0;
}
static int am33xx_evm_tx_clk_dly_phy_fixup(struct phy_device *phydev)
{
	phy_write(phydev, AR8051_PHY_DEBUG_ADDR_REG,AR8051_DEBUG_RGMII_CLK_DLY_REG);
...
static void setup_ok335x(void)
{
	...
	phy_register_fixup_for_uid(AM335X_YT8521_EVM_PHY_ID, AM335X_YT8521_EVM_PHY_MASK,
                                   am33xx_evm_tx_clk_dly_phy_fixup_YT8521);
}
